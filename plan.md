...
- [ ] 테스트: 로또 번호가 6개가 아닐 경우 Error 발생
- [ ] 테스트: 로또 번호에 중복된 숫자가 있을 경우 Error 발생
- [ ] 테스트: 로또 번호가 1~45 범위를 벗어날 경우 Error 발생
- [ ] 테스트: 로또 번호를 오름차순으로 정렬하여 반환
- [ ] 테스트: 주어진 숫자와 일치하는 번호 개수를 반환
- [ ] 테스트: 특정 보너스 번호를 포함하는지 확인
- [ ] 구현: Lotto 클래스
...
- [ ] 테스트: 구입 금액에 따라 올바른 개수의 로또 생성
  - 예: 3000원 → 3개
- [ ] 테스트: 생성된 각 로또가 1~45 범위의 중복되지 않는 6개 숫자를 가짐
- [ ] 테스트: 생성된 로또 번호가 오름차순으로 정렬됨
- [ ] 구현: LottoMachine 클래스
