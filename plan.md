...
- [x] 테스트: 6개 일치 시 1등 (2,000,000,000원)
- [x] 테스트: 5개 일치 + 보너스 일치 시 2등 (30,000,000원)
- [x] 테스트: 5개 일치 시 3등 (1,500,000원)
- [x] 테스트: 4개 일치 시 4등 (50,000원)
- [x] 테스트: 3개 일치 시 5등 (5,000원)
- [x] 테스트: 2개 이하 일치 시 null (낙첨)
- [x] 구현: LottoRank enum/클래스
